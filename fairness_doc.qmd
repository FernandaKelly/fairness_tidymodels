...
Com informações sobre a permanência de um paciente com diabetes em um hospital, como dados demográficos, resultados de diagnóstico, pagamento e medicamentos, um hospital pode treinar um modelo de aprendizado de máquina para prever razoavelmente bem se um paciente será readmitido dentro de 30 dias. Mas que danos para os pacientes poderiam resultar do uso de tal modelo?
