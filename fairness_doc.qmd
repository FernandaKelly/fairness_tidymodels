...
Neste caso, vamos utilizar a opção de **strata** com a variável **readmitted** com o objetivo de abordar o desequilíbrio de classe. Para saber mais sobre desequilíbrios de classe e estratificação, consulte o capítulo “Métodos comuns para divisão de dados” de Modelagem organizada com R (Kuhn e Silge 2022) que é incrível e vai te ajudar a entender a escolha da utilização dessa reamostragem.
